...
////
//// Compile/run: $> g++ -fopenmp -o xxx Park-omp-trap1.cpp
...
int main(int argc, char* argv[])
{
   ...
   #pragma omp parallel num_threads(thread_count) reduction(+:global_result)
    global_result += Trap(a, b, n, global_result); //global_result is ref para
...
//////////////////
double Trap(double a, double b, int n, double& global_result)
{
